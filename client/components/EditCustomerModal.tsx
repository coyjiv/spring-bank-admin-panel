import React, { Dispatch, Fragment, MouseEventHandler, SetStateAction, useRef, useState } from 'react'
...
const EditCustomerModal = ({ open, handleClose, customer, handleUpdate }: Props) => {
    ...
    const submit = (e: React.MouseEvent) => {
        ...
        setIsPending(true)
        fetch(SERVER_URL + '/customers/edit', {
            method: 'PUT',
            headers: {
